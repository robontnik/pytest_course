...
from clients.users.usersSchema import CreateUserRequestSchema, CreateUserResponseSchema, GetUserResponseSchema
...
domain = {
    ...
    'gmail.com' : 'User with ddomain gmail.com',
    'example.com' : 'User with domain example.com'
}

@pytest.mark.users
@pytest.mark.regression
@pytest.mark.parametrize('email', domain.keys(), ids = lambda email : f'{domain[email]}')
